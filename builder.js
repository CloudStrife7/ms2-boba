...
<a class="text-[${osv}]/30 hover:text-[${osv}]/60 transition-all font-['Plus_Jakarta_Sans'] text-[9px] tracking-[0.2em] uppercase mt-2 flex items-center gap-1.5" href="https://github.com/CloudStrife7/ms2-boba" target="_blank" rel="noopener">
